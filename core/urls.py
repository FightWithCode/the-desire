...
urlpatterns = [
    ...
    path("payment-graph/", payment_graph_view, name="payment_graph_view"),
    path("subscription-graph/", subscription_graph_view, name="subscription_graph_view"),
]
app_name = 'shop'
